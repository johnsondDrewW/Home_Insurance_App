...
<html>
	...
	<body>
		...
		<div class= "text-center">
			<img class="rounded mx-auto d-block"src="https://i.pinimg.com/564x/e3/f9/bb/e3f9bbcaa4cbca629b144aa54c769697.jpg">
		</div>
		</div>
		<div class = "col-md-6 right">
		<button type = "button" onclick ="window.location.href='../GetQoute'"  >Get Quote</button>
		<button type = "button" onclick ="window.location.href='../ViewQoutes'" >View Quote</button>
		</div>
	</body>
</html>